 ...
 * 개인 페이지 좋아하는 사람들
 */
public class UserPageLikeUserActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_page_liker);
    ...
    private void getNetwork() {
        ...
        HttpRequest.setHttp1(this, URLAddress.MEMBER_FOLLOWERS(), mParams, new OnTask() {
            @Override
            public void onTask(int output, String result) {
                ...
                if (Utils.getJsonData(result, "code").equals("SUCCESS")) {
                    ...
                    Utils.setToast(UserPageLikeUserActivity.this, Utils.getJsonData(result, "message") + " ( " + Utils.getJsonData(result, "code") + " )");
                }
            }
        });
    ...
    private void setData(String data) {
        try {
            ...
            if (JsonArray_attends.length() > 0) {
                ...
                HomeFragment_detail_assistUserAdapter homeFragment_detail_assistUserAdapter = new HomeFragment_detail_assistUserAdapter(UserPageLikeUserActivity.this, listAttends);
    ...
    private void setView() {
        ...
        try {
            ...
            navi_tv01.setText(getString(R.string.liker2).replace("{NICKNAME}", Utils.getJsonData(JsonObject_attends.toString(), "nick")));
