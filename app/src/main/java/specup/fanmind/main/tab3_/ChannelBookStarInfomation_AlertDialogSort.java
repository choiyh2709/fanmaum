...
public class ChannelBookStarInfomation_AlertDialogSort extends DialogFragment {
    ...
    public ChannelBookStarInfomation_AlertDialogSort(Context context, String title, ResultInterface resultInterface, String[] content , String selectSortValue) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.alertdialog_sort_newfeed, container);
