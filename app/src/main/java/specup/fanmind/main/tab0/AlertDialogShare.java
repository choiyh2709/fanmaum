...
public class AlertDialogShare extends DialogFragment {
    ...
    public AlertDialogShare(Context context, String total_Json, CallbackManager callbackManager) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.button_share_kakao: {
                    OAuthID.shareKakaotalk(context, total_Json,0);
                }
                break;
                case R.id.button_share_twitter: {
                    OAuthID.shareTwitter(context,0);
                }
                break;
                case R.id.button_share_facebook: {

                    OAuthID.shareFacebook(context, total_Json, callbackManager,0);
                }
                break;
