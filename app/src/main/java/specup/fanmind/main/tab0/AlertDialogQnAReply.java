 ...
 * 답글
 */
public class AlertDialogQnAReply extends DialogFragment {
    ...
    public AlertDialogQnAReply(AlertDialogQnA alertDialogQnA, Context context, CommentList2 commentList2, String sSrl) {
