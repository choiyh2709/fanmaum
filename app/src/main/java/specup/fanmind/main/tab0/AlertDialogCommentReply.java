 ...
 * 답글
 */
public class AlertDialogCommentReply extends DialogFragment {
    ...
    public AlertDialogCommentReply(AlertDialogComment alertDialogComment, Context context, CommentList2 commentList2, String sSrl) {
...
//        mParams.add(new BasicNameValuePair("board", "7"));
        ...
        mParams.add(new BasicNameValuePair("next", "0"));
        mParams.add(new BasicNameValuePair("pageable", "false"));
