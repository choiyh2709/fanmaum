...
import specup.fanmind.main.tab0.AlertDialogComment;
import specup.fanmind.main.tab0.AlertDialogCommentReply;
...
public class CommentAdapter2 extends BaseAdapter {
    ...
    private AlertDialogComment alertDialogComment;

    public CommentAdapter2(AlertDialogComment alertDialogComment, Context context, List<Object> mList, String sSrl, View.OnClickListener onClickListener) {
        this.mList = mList;
        this.sSrl = sSrl;
        this.onClickListener = onClickListener;
        this.alertDialogComment = alertDialogComment;
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.textView_recomment_reply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialogCommentReply alertDialogCommentReply = new AlertDialogCommentReply(alertDialogComment, mContext, commentList2, (((CommentList2) mList.get(position)).getReply_srl()));
                alertDialogCommentReply.show(ActivityManager.fragmentManager, "commentReply");
            }
        });
        ...
        holder.textView_comment_reply_all.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialogCommentReply alertDialogCommentReply = new AlertDialogCommentReply(alertDialogComment, mContext, commentList2, sSrl);
                alertDialogCommentReply.show(ActivityManager.fragmentManager, "commentReply");
            }
        });
