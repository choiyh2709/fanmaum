...
public class TimelineCommentAdapter extends BaseAdapter{
	...
	public TimelineCommentAdapter(Context context,  ArrayList<CommentList> mList, OnClickListener onClickListener){
		this.mList = mList;
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView ==null){
			holder = new Holder();
			convertView = layout_In.inflate(R.layout.list_timelinecomment, null);
		...
		if(comment!=null){
			...
			holder.mContents.setText(comment.getContent());
