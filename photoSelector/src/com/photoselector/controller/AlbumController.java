...
public class AlbumController {
	...
	public List<AlbumModel> getAlbums(Context context) {
		...
		cursor.moveToLast();
		AlbumModel current = new AlbumModel(context.getResources().getString(R.string.recent_photos), 0, cursor.getString(cursor.getColumnIndex(ImageColumns.DATA)), true); // "最近照片"相册
		albums.add(current);
		do {
